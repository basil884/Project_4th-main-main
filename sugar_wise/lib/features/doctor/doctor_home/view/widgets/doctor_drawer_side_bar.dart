...
// سايد بار
class CustomDoctorSideBar extends StatelessWidget {
  final String currentPage;
  CustomDoctorSideBar({super.key, this.currentPage = 'Home'});
  ...
  Widget build(BuildContext context) {
    ...
    final doctorName = userData != null
        ? "${userData['firstName'] ?? ''} ${userData['lastName'] ?? ''}".trim()
        : doctorProfileVM.doctorName;
    final doctorEmail = userData?['email'] ?? "basil@gmail.com";
